...
class TestPIDirectGraph(unittest.TestCase):
    ...
    def test_dijkstra(self):
        ...
        g2.add_arch(1, 3, 1, 0)
        g2.add_arch(3, 4, 1, 0)
        res = g2.get_sssp_dijkstra(1)

        self.assertEqual(distances.get(1), 7)
        self.assertEqual(distances.get(2), 9)
        self.assertEqual(distances.get(3), 3)
        self.assertEqual(distances.get(4), 0)
        self.assertEqual(distances.get(5), 14)
        self.assertEqual(distances.get(6), 4)
        self.assertEqual(distances.get(7), 4)
